...
<body>
                ...
                <div class="content-main">
                    <div class="content__breadcrumb">
                        <nav class="breadcrumb mb-0">
                            ...
                            <a class="breadcrumb-item active" aria-current="page">Thêm danh mục</a>
                        </nav>
                    </div>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if (in_array($img_type, $allowedTypes) && $img_size < $maxFileSize) {
                            if (file_exists($targetFile)) {
                                ...
                                try {
                                    $sql = $conn->prepare("INSERT INTO category (category_name, category_img) VALUES (:category_name, :category_img)");
                            ...
                            echo '<script>
                                Swal.fire({
                                    icon: "error",
                                    title: "Lỗi!",
                                    text: "Chỉ được phép upload ảnh định dạng jpg hoặc png và kích thước nhỏ hơn 4MB.",
                                });
                                </script>';
                        }
                    }
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="row  g-4">
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <input type="text" name="cate_name" id="" class="form-control" placeholder="Ví dụ: Hoa quả" aria-describedby="helpId" required />
                                </div>
    ...
    <!-- main js -->
    <script src="../assets/js/ckedi.js"></script>
